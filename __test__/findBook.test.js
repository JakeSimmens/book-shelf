...
const formatBookDataFromGoogle = require("../routes/findBook").formatBookDataFromGoogle;
...
describe("Route /findBook", () => {
    ...
    describe("formatBookDataFromGoogle", () => {
        it("should reformat object from GoogleBooks", ()=>{
            ...
            expect(data.publisher).toBe(dataOfBook.volumeInfo.publisher);
            expect(data.publishedDate).toBe(dataOfBook.volumeInfo.publishedDate);
            expect(data.description).toBe(dataOfBook.volumeInfo.description);
            expect(data.pageCount).toBe(dataOfBook.volumeInfo.pageCount);
            expect(data.categories).toBe(dataOfBook.volumeInfo.categories);
            expect(data.averageRating).toBe(dataOfBook.volumeInfo.averageRating);
            expect(data.ratingsCount).toBe(dataOfBook.volumeInfo.ratingsCount);
            expect(data.imageLinks).toBe(dataOfBook.volumeInfo.imageLinks);
         });
    });
